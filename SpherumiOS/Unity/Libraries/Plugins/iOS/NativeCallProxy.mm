...
void
setPlayMode(RunPlayer delegate)
{
    [api onSetRunPlayer: delegate];
}
void
setCreatorMode(RunCreator delegate)
{
    [api onSetRunCreator: delegate];
}
void
setTestMode(RunTest delegate)
{
    [api onSetRunTest: delegate];
}
